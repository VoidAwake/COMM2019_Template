...
public class PlayerController : MonoBehaviour
{
   ...
   {
        Vector3 targetVelocity = new Vector2(horizontalMove * movementSmoothing, m_Rigidbody.velocity.y);     //Calculates the new velocity that the player will use after the key is released
